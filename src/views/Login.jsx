    ...
    >
      ...
      <Box
        sx={{
          ...
          width: "100%",
          boxShadow:
            "0 30px 80px rgba(0, 0, 0, 0.15), 0 0 0 1px rgba(255, 255, 255, 0.5)",
      ...
      >
        ...
        <Box
          sx={{
            ...
            mb: 5,
            animation:
              "fadeInDown 1.2s cubic-bezier(0.16, 1, 0.3, 1) 0.3s both",
          }}
        >
          <Box
            sx={{
        ...
        >
          ...
          <Box
            sx={{
              mb: 4,
              animation:
                "fadeInLeft 1s cubic-bezier(0.16, 1, 0.3, 1) 0.5s both",
            }}
          >
            <Typography
              sx={{
          ...
          <Box
            sx={{
              mb: 4,
              animation:
                "fadeInLeft 1s cubic-bezier(0.16, 1, 0.3, 1) 0.7s both",
            }}
          >
            <Typography
              sx={{
          ...
          <Box
            sx={{
              ...
              mb: 5,
              animation:
                "fadeInRight 1s cubic-bezier(0.16, 1, 0.3, 1) 0.9s both",
            }}
          >
            <FormGroup>
              <FormControlLabel
